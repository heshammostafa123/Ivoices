                    ...
                    <form action="{{ route('invoices.update','test') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_due_date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoices->invoice_due_date }}">
                            ...
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id}}"  @if($section->id==$invoices->section->id)?'selected':'' @endif?> {{ $section->section_name }}</option>
                                    @endforeach
                                </select>
                                @error('section_id')
                                    <div class="alert alert-danger">{{ $message }}</div>
